...
/** Catálogo oficial e completo com os 14 serviços reais da Barbearia Vieira */
export const SERVICOS_REAIS_CATALOGO: Servico[] = [
  // Cortes
  {
    id: 'srv-corte-degrade',
    nome: 'Corte degradê',
    descricao: 'Degradê na régua com fade moderno e acabamento limpo',
    preco: 20.0,
    duracao_minutos: 30,
    ativo: true,
    categoria: 'cortes',
  },
  {
    ...
    descricao: 'Acabamento ultra preciso na navalhete e contorno alinhado',
    preco: 23.0,
    duracao_minutos: 35,
    ativo: true,
    categoria: 'cortes',
  },
  {
    id: 'srv-corte-social',
    nome: 'Corte Social',
    descricao: 'Corte tradicional e elegante executado na tesoura e máquina',
    preco: 18.0,
    duracao_minutos: 30,
    ativo: true,
    categoria: 'cortes',
  ...
  // Sobrancelha
  {
    id: 'srv-sobrancelha',
    nome: 'Sobrancelha',
    descricao: 'Design e alinhamento de sobrancelha masculino com pinça e navalha',
    preco: 10.0,
    duracao_minutos: 15,
    ativo: true,
  ...
  // Limpeza de Pele
  {
    ...
    descricao: 'Remoção profunda de impurezas faciais, esfoliação e revitalização',
    preco: 20.0,
    duracao_minutos: 25,
    ativo: true,
